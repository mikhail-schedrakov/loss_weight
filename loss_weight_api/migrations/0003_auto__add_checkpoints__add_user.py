...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('loss_weight_api_user', (
            ...
            ('current_waight', self.gf('django.db.models.fields.DecimalField')(decimal_places=2, max_digits=3)),
            ('initial_waight', self.gf('django.db.models.fields.DecimalField')(decimal_places=2, max_digits=3)),
